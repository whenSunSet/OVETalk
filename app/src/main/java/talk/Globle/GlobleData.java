...
//	public static final String GROUP_SEND_MESSAGE="http://39.191.127.100:8080/OVE/group/sendMessage.do";
    ...
    public static final int USER_JOIN_GROUP=3;

    public static final int USER_OUT_GROUP=4;

    public static final int USER_CANCEL_GROUP=5;

    public static final int AGREE_USER_TO_GROUP=6;

    public static final int DISAGREE_USER_TO_GROUP=7;

    public static final int USER_REQUEST_JOIN_GROUP=8;

    public static final int MASTER_PUT_TASK=9;

    public static final int USER_PUT_HOMEWORK=10;

    public static final int MASTER_AGREE=11;

    public static final int MASTER_DISAGREE=12;

    public static final int YOU_AGREE_TO_JOIN_GROUP=13;

    public static final int YOU_DISAGREE_TO_JOIN_GROUP=14;
